...
const AddQuery = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!user) {
      Swal.fire("❌ Not Authenticated", "Please log in first.", "error");
      return;
    }
    ...
    try {
      ...
      if (res.status === 201) {
        Swal.fire(
          "✅ Query Added!",
          "Your product query has been submitted.",
          "success"
        );
        setFormData({
          productName: "",
        ...
        <div className="w-full max-w-5xl bg-white border border-blue-200 rounded-lg shadow-lg p-4 sm:p-6 md:p-10">
          <div className="text-center mb-8 md:mb-10">
            <h1 className="text-2xl sm:text-3xl font-bold text-blue-950">
              📝 Share Your Product Concern
            </h1>
            <p className="text-gray-600 mt-2 text-sm sm:text-base">
              Submit your queries about products you’re not satisfied with and
              let others recommend better alternatives.
            </p>
          </div>
